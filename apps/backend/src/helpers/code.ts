...
export const externalLibs = [
  ...
  // 'gleap-admin',
  // 'stream',
  // '@aws-sdk/client-textract/dist-types/models/models_0',
  // '@aws-sdk/client-textract/models/models_0',
  // '@aws-sdk/util-dynamodb',
  // '@aws-sdk/client-pinpoint-email/dist-types/commands/SendEmailCommand',
];
