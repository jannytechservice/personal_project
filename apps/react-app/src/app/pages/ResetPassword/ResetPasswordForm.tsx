  ...
  return (
    ...
    >
      <WBForm onSubmit={handleSubmit(onSubmit)} alignSelf="stretch">
        ...
        {authError?.name && (
          <WBAlert
            title={t(authError.name, { ns: 'authentication' })}
            severity="error"
          />
        )}
        ...
        {!codeDelivery && (
          <WBTypography textAlign="center" variant="body2" mt={2}>
            {`${t('rememberPassword', { ns: 'common' })} `}
            <WBLink to={PATHS.signIn} underline="always" variant="body2">
